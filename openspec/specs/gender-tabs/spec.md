# gender-tabs Specification

## Purpose

Gender filter navigation tabs (Mujer/Hombre/Kids/Unisex) in header, navigating to /productos?gender={value} with active state detection.
