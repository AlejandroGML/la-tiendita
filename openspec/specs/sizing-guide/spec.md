# sizing-guide Specification

## Purpose

Sizing guide modal: women's and men's measurement tables (chest/waist/hips) in p-dialog, triggered from product detail size selector area.
