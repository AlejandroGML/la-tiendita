# color-swatches-card Specification

## Purpose

Color swatch display on product cards: up to 5 circular swatches derived from variant color_hex with COLOR_MAP fallback and +N overflow indicator.
