# badges-system Specification

## Purpose

Product card badge system: Bestseller (top 10 by orders) and Nuevo (≤7 days) badge chips with priority stacking (SALE > Bestseller > Nuevo).
