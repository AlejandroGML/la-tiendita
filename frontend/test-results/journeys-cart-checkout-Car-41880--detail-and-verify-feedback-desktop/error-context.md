...
- Name: journeys/cart-checkout.spec.ts >> Cart + Checkout Journey >> add product to cart from product detail and verify feedback
- Location: tests/journeys/cart-checkout.spec.ts:5:7

# Error details

```
Error: Rate limited, retry 5/5
```
